...
const char *QsciLexerTeX::keywords(int set) const
{
    if (set == 1)
        return
            ...
            "vphantom phantom smash borderdist defineoverlay useMPgraphic "
            "rotate dimexpr1cm setlayerframed externalfigure dimexpr contwidth "
            "page setupMPvariables getfiguredimensionsonly stopuseMPgraphic "
            "expanded startMPenvironment enableregime mainlanguage setupencoding "
            "setupcolors setupsystem stopMPenvironment definecolor startMPinclusions "
            "MPcolor stopMPinclusions setuppapersize setuplayout setuppagenumbering "
            "startuseMPgraphic overlaywidth overlayheight textwidth textheight "
            "definelayer setupbackgrounds starttext naturalfigurewidth MPvar "
            "figurewidth figureheight naturalfigureheight stoptext";
